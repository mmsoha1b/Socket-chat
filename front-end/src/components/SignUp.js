...
const SignUp = ({ setUsers, users }) => {
  ...
  const signUpButton = formValidity ? (
    <Button className={"mb-5 mt-3"} variant='danger' type='submit'>
      Signup
    </Button>
  ) : (
    <Button className={"mb-5 mt-3"} variant='danger' type='submit' disabled>
      Signup
    </Button>
  );
  return (
            ...
            <Form onSubmit={createNewUser}>
              ...
              <Form.Group className='mb-2'>
                ...
                <Form.Control
                  ...
                  className={
                    username === "" && usernameActive ? "form-error" : ""
                  }
                />
              ...
              <Form.Group className='mb-2'>
                ...
                <Form.Control
                  ...
                  className={
                    password === "" && passwordActive ? "form-error" : ""
                  }
                />
                {password === "" && passwordActive ? (
                  <div className='ms-2 error-text'>
                    <b>
                      <i>Password can't be empty</i>
                    </b>
                  </div>
                ) : (
                  ""
                ...
                {password.length > 0 && password.length < 6 ? (
                  <div className='ms-2 error-text'>
                    <b>
                      <i>Password must be 6 characters long</i>
                    </b>
                  </div>
                ) : (
                  ""
              ...
              <Form.Group className='mb-2'>
                ...
                <Form.Control
                  ...
                  className={
                    confirmPassword !== password && confirmPasswordActive
                      ? "form-error"
                      : ""
                  }
                />
